    ...
    <div class="navbar navbar-inverse navbar-fixed-top bs-docs-nav">
        <div class="container">
            ...
            <div class="nav-collapse nav-bar collapse" collapse="isNav">
                ...
                <ul class="nav navbar-nav">
                    <li class="acive"><a href="/"><span
                            class="glyphicon glyphicon-home"></span> 首页</a></li>
                    <li><a href="/selection"><span
                ...
                <div class="modal-body">
                    <form class="form-horizontal" name="loginForm">
                        <div class="login-row row" ng-class="{'has-error': (loginUserF && !(loginForm.loginUser.$valid)) || userNExist}">
                            ...
                            <div class="col-lg-10">
                                <input class="input-with-feedback" type="text" id="loginUser" name="loginUser" placeholder="用户名" autocomplete="off"
                                       ng-model="login.user"
                                       ng-click="rmNUE()"
                                       ng-focus="loginUserF"
                        ...
                        <div class="login-row row" ng-class="{'has-error': (loginPsdF && !(loginForm.loginPsd.$valid)) || passError}">
                            ...
                            <div class="col-lg-10">
                                <input class="input-with-feedback" type="password" id="loginPsd" name="loginPsd" placeholder="密码" autocomplete="off"
                ...
                <div class="modal-body">
                    <form class="form-horizontal" name="signupForm">
                        <div class="signup-row row" ng-class="{'has-error': (signupUserF && !(signupForm.signupUser.$valid)) || userExist}">
                            ...
                            <div class="col-lg-10">
                                <input class="input-with-feedback" type="text" id="signupUser" name="signupUser" placeholder="用户名" autocomplete="off"
                        ...
                        <div class="signup-row row" ng-class="{'has-error': signupPsdF && !(signupForm.signupPsd.$valid)}">
                            ...
                            <div class="col-lg-10">
                                <input class="input-with-feedback" type="password" id="signupPsd" name="signupPsd" placeholder="密码" autocomplete="off"
                        ...
                        <div class="signup-row row" ng-class="{'has-error': signupPsddF && (!(signupForm.signupPsdd.$valid) || (signup.password != signup.passwordConfirm))}">
                            ...
                            <div class="col-lg-10">
                                <input class="input-with-feedback" type="password" id="signupPsd1" name="signupPsdd" placeholder="确认密码" autocomplete="off"
...
<div class="container">
    <div class="bs-masthead">
        ...
        <p>
            <a href="#" class="btn btn-large">关于我们</a>
        </p>
...
<script src="${request.static_url('api:static/angular-seed/app/lib/angular/angular-cookies.js')}"></script>
