...
b){var d,e,f,j;if(a)if(b===q)i.cookie=a+"=;path="+R+";expires=Thu, 01 Jan 1970 00:00:00 GMT";else{if(B(b))d=(i.cookie=a+"="+b+";path="+R).length+1,d>4096&&c.warn("Cookie '"+a+"' possibly not set or overflowed because it was too large ("+d+" > 4096 bytes)!")}else{if(i.cookie!==$){$=i.cookie;d=$.split("; ");r={};for(f=0;f<d.length;f++)e=d[f],j=e.indexOf("="),j>0&&(a=e.substring(0,j),r[a]===q&&(r[a]=e.substring(j+1)))}return r}};f.defer=function(a,b){var c;
